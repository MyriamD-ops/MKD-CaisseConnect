...
function Label({ children }) {
    return (
        <p className="text-xs font-semibold text-slate-500 uppercase tracking-widest mt-3 mb-1.5">
            {children}
        </p>
    );
}
            ...
            <main className="max-w-5xl mx-auto px-4 py-8 lg:px-10 lg:py-12">
                ...
                <Section title="Palette de couleurs">
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
                        {[
                            ...
                            <div key={c.name}>
                                <div
                                    className="h-16 rounded-xl border border-slate-200 mb-2"
                ...
                <Section title="Typographie">
                    <Card className="p-6 lg:p-8 space-y-5">
                        <div>
                            <p className="text-4xl font-bold text-slate-800 leading-tight">H1 · Bold 36px</p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-4xl font-bold text-slate-800</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-slate-800 leading-tight">H2 · Bold 30px</p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-3xl font-bold</p>
                        </div>
                        <div>
                            <p className="text-2xl font-semibold text-slate-800">H3 · Semibold 24px</p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-2xl font-semibold</p>
                        </div>
                        <div>
                            <p className="text-xl font-semibold text-slate-800">H4 · Semibold 20px</p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-xl font-semibold</p>
                        </div>
                        <div>
                            <p className="text-base text-slate-800 leading-relaxed">
                                Corps de texte — Regular 16px. Texte de contenu principal utilisé dans les cards, descriptions et paragraphes.
                            </p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-base text-slate-800</p>
                        </div>
                        <div>
                            <p className="text-sm text-slate-500 leading-relaxed">
                                Texte secondaire — 14px. Métadonnées, dates, informations complémentaires.
                            </p>
                            <p className="text-xs text-slate-500 font-mono mt-1">text-sm text-slate</p>
                        </div>
                        <div>
                ...
                <Section title="Boutons">
                    <Card className="p-6">
                        <div className="flex flex-wrap gap-3">
                            ...
                            {/* Secondaire */}
                            <div className="flex flex-col items-center gap-2">
                                <button className="h-11 px-6 bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-800 font-semibold rounded-xl text-sm border border-slate-200 transition-colors">
                                    Modifier
                                </button>
                            ...
                            {/* Danger */}
                            <div className="flex flex-col items-center gap-2">
                                <button className="h-11 px-6 bg-red-50 hover:bg-red-100/20 text-red-500 font-semibold rounded-xl text-sm border border-red-200 transition-colors">
                                    Supprimer
                                </button>
                            ...
                            {/* Ghost / outline */}
                            <div className="flex flex-col items-center gap-2">
                                <button className="h-11 px-6 bg-transparent hover:bg-dark/5 text-slate-800 font-semibold rounded-xl text-sm border-2 border-dark/30 hover:border-dark/50 transition-colors">
                                    Annuler
                                </button>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <Card className="p-5">
                            ...
                            <input
                                type="text"
                                defaultValue="sophie"
                                className="w-full h-12 px-4 bg-white border-2 border-red-200 rounded-xl text-slate-800 text-sm ring-2 ring-ruby/15 outline-none"
                            />
                        ...
                        <Card className="p-5">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-0 top-0 w-12 h-12 flex items-center justify-center text-slate-500 hover:text-slate-800 transition-colors"
                                >
                                    {showPin ? '🙈' : '👁️'}
                                </button>
                            </div>
                            <p className="text-xs text-slate-500 mt-1.5">4 à 6 chiffres</p>
                        </Card>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Card className="p-5 flex flex-col gap-4">
                            ...
                            <div className="flex gap-2 mt-auto">
                                <button className="flex-1 h-11 flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-800 rounded-xl text-sm font-medium transition-colors">
                                    ✏️ Modifier
                                </button>
                                <button className="flex-1 h-11 flex items-center justify-center bg-red-50 hover:bg-red-100/20 text-red-500 rounded-xl text-sm font-medium transition-colors border border-red-200">
                                    🗑️ Supprimer
                                </button>
                            </div>
                        </Card>
                        ...
                        <Card className="p-5 flex flex-col gap-4">
                            <div className="flex items-start justify-between gap-2">
                                <h3 className="font-semibold text-slate-800">Bague Dorée Fleur</h3>
                                <span className="shrink-0 text-xs font-semibold px-2.5 py-1 rounded-full bg-red-50 text-red-500 border border-red-200">
                                    ⚠ Bas
                                </span>
                            </div>
                            <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm">
                ...
                <Section title="Badges & Tags">
                    <Card className="p-6">
                        <div className="flex flex-wrap gap-3">
                            ...
                            <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-dark/10 text-slate-800 border border-dark/20">
                                Terminé
                            </span>
                            <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-500 border border-slate-200">
                                Espèces
                ...
                <Section title="Notifications & Alertes">
                    <div className="space-y-3">
                        ...
                        {/* Danger */}
                        <div className="flex items-start gap-3 p-4 bg-red-100/5 border border-red-200/30 rounded-xl text-sm">
                    ...
                    <Card className="p-5 max-w-sm">
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex-1 min-w-0 mr-2">
                                <p className="text-sm font-semibold text-slate-800 truncate">Collier Argent Étoile</p>
                                <p className="text-xs text-slate-500 mt-0.5">28.00€ × 3</p>
                            </div>
                            <button className="w-7 h-7 flex items-center justify-center rounded-lg text-red-500 hover:bg-red-50 transition-colors text-lg leading-none shrink-0">
                                ×
                            </button>
                        </div>
                ...
                <Section title="Login card (aperçu)">
                    <div className="flex justify-center">
                        <div className="w-full max-w-sm">
                            <Card className="p-8">
                                <h2 className="text-lg font-semibold text-slate-800 text-center mb-7">
                                    Connexion
                                </h2>
                            ...
                            <p className="text-center mt-4 text-xs text-slate-500">CaisseMobile · Version 1.0</p>
                        </div>
                    </div>
                </Section>
