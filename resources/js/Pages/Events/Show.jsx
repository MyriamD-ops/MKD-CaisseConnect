            ...
            <main className="p-4 lg:p-6 max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/60 shadow-sm p-6">
                        ...
                        <div className="divide-y divide-slate/10">
                            <div className="flex justify-between items-center py-3">
                                ...
                                <span className="text-sm font-medium text-slate-800">{evenement.lieu || 'Non précisé'}</span>
                            </div>
                            <div className="flex justify-between items-center py-3">
                            ...
                            <div className="flex justify-between items-center py-3">
                                ...
                                <span className="text-sm font-medium text-slate-800">{evenement.produits?.length || 0} produit(s)</span>
                            </div>
                            <div className="flex justify-between items-center py-3">
                                <span className="text-sm text-slate">Code d'accès</span>
                                <span className="text-sm font-mono font-semibold text-slate-800">{evenement.code_unique}</span>
                            </div>
                        </div>
                    ...
                    <div className="bg-white/70 backdrop-blur-md rounded-2xl border border-white/60 shadow-sm p-6 flex flex-col items-center">
                        ...
                        <button
                            onClick={downloadQR}
                            className="w-full h-11 bg-slate-100 hover:bg-slate-200 text-slate-500 hover:text-slate-800 border border-slate-200 rounded-xl text-sm font-medium transition-colors mb-3"
                        >
