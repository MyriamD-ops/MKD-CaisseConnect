    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            ...
            <main className="p-4 lg:p-6 max-w-7xl mx-auto">
                ...
                <h2 className="text-2xl font-bold text-slate-800 mb-6">Nouvel événement</h2>
                                            ...
                                            <div key={p.id} className="bg-white/50 rounded-xl p-3 border border-slate-200">
                                                <div className="flex items-center justify-between mb-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-7 h-7 flex items-center justify-center text-red-500 hover:bg-red-50 rounded-lg transition-colors text-lg leading-none shrink-0"
                                                    >×</button>
                                                </div>
